const SIDEBAR_ICONS = {
  ...
  analyse: `<svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><circle cx="10" cy="10" r="7"/><path d="M10 3v7h7"/></svg>`,
...
const SIDEBAR_LINKS = [
  ...
  { href: "/analyse.html", page: "analyse", label: "Analyse", icon: SIDEBAR_ICONS.analyse },
